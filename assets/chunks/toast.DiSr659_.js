...
</svg>`,m=`<?xml version="1.0" standalone="no"?>
...
</svg>`;var x=Object.defineProperty,u=Object.getOwnPropertyDescriptor,a=(i,e,n,t)=>{for(var s=t>1?void 0:t?u(e,n):e,r=i.length-1,p;r>=0;r--)(p=i[r])&&(s=(t?p(e,n,s):p(s))||s);return t&&s&&x(e,n,s),s};const y={info:f,success:m,error:h};let o=class extends d{constructor(){super(...arguments),this.message="",this.type="info",this.duration=2e3,this.leaving=!1}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.close(),this.duration)}close(){this.leaving=!0,setTimeout(()=>this.remove(),300)}render(){return g`
      <div
